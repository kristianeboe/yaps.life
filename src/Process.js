...
const Process = () => (
  <Segment vertical textAlign="center" style={{ padding: '5em 0em' }}>
    ...
    <p style={{ fontSize: '1.33em' }}>
      ...
      preferanser. Siden vi vet du har sommerjobb kan vi anta at du både er betalingsdyktig og en god leietaker noe som
      vil gjøre det lettere å pitche deg inn for utleiere over hele byen.
    </p>
