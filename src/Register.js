      ...
      <Form onSubmit={() => this.setState({ activeIndex: 3 })}>
        ...
        <Form.Field required>
          ...
          <PlacesAutocomplete
            ...
            onSelect={(workplace) => this.setState({workplace})}
        ...
        <Form.Field>
          ...
          <Dropdown
            ...
            name="field_of_work"
            value={this.state.field_of_work}
            fluid
            multiple
            search
            selection
      ...
      <Form onSubmit={() => this.setState({ activeIndex: 4 })}>
        ...
        <Form.Field>
          ...
          <Dropdown
            ...
            value={this.state.preferences_personality}
            fluid
            multiple
            search
            selection
        ...
        <Form.Field>
          ...
          <Dropdown
            ...
            value={this.state.preferences_interests}
            fluid
            multiple
            search
            selection
        ...
        <Form.Field>My habbits are my life</Form.Field>
        <Form.Field>
          <label>I want to live with people who are</label>
          <Dropdown
            label="Roommates"
            placeholder="Roommates"
            name="preferences_roommates"
            value={this.state.preferences_roommates}
            fluid
            multiple
            search
            selection
            options={preferences_roommates_options}
            onChange={this.handleChange}
          />
        </Form.Field>
        <Button type="submit">Next section</Button>
      ...
      <Form loading={this.state.form_loading} success={this.state.form_success} onSubmit={this.handleCompletion}>
        ...
        <Form.Group>
          ...
          <Form.Input
            ...
            name="max_rent"
            value={this.state.max_rent}
            onChange={this.handleChange}
          />
        </Form.Group>
        <TextArea
          label="Other notes"
          placeholder="Other requests, notes or concerns?"
          name="other_requests"
          value={this.state.other_requests}
          onChange={this.handleChange}
        />
        <Form.Checkbox
          required
          ...
          name="tos_checkbox"
          value={this.state.tos_checkbox}
          onChange={this.handleChange}
        />
        <Button type="submit">Get matched now!</Button>
        <Message success header="Form Completed" content="You've been registered! We'll be in touch soon" />
      </Form>
    )
    const paneNames = ['About you', 'Education', 'Work', 'Preferences', 'Test', 'Submit']
    const panes = [pane1, pane2, pane3, pane4, pane5].map((pane, key) => ({
      menuItem: paneNames[key],
